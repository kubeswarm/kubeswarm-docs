...
| ---------------------- | ---------------------------------------------------- | ------------------------------------------------------------ |
| **4 - Orchestration**  | SwarmTeam, SwarmRun, SwarmEvent                      | Compose agents into workflows, track execution, trigger runs |
| **3 - Compute**        | SwarmAgent                                           | The atomic unit - manages a pool of LLM agent pods           |
| **2 - Discovery**      | SwarmRegistry                                        | Capability index - agents register, teams query              |
| **1 - Infrastructure** | SwarmSettings, SwarmMemory, SwarmBudget, SwarmNotify | Shared config, memory, spend control, notifications          |
