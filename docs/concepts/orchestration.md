...
See [Parallel Fan-Out](/advanced/parallel-fan-out) for details and [cookbook recipe 07](https://github.com/kubeswarm/kubeswarm-cookbook/tree/main/teams/07-parallel-fan-out) for a working example.
