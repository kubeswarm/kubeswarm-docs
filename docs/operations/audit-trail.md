...
- **Structured logging** for runtime debugging (see [Observability](/operations/observability))
- **Audit trail** for behavior reconstruction, compliance, and cost attribution
- **SwarmBudget** for aggregate spend limits (see [Budget Management](/finops/budget-management))
