...
| `imagePullSecrets` _[LocalObjectReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.33/#localobjectreference-v1-core) array_ | ImagePullSecrets is a list of references to secrets for pulling the agent<br />container image from private registries. Overrides the operator-level<br />--agent-image-pull-secrets flag for this agent. |  | Optional: true <br /> |
