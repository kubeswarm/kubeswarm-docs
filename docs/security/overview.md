...
# kubeswarm Security - Defense-in-Depth for Agents on Kubernetes
...
- [Guardrails and Trust](/security/guardrails) - tool allow/deny, trust levels, execution limits
- [MCP Policy](/security/mcp-policy) - URL allowlist, auth requirements
- [Network Policies](/security/network-policies) - pod egress control
- [API Key Management](/security/api-key-management) - native Kubernetes Secrets
